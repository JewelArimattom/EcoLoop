...
import { 
  Calendar, Truck, CreditCard, Recycle, Clock, Home, 
  Shield, CheckCircle, Phone, Mail, MessageCircle,
  ArrowLeft, DollarSign, Sparkles
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative bg-gradient-to-br from-emerald-900 via-teal-900 to-cyan-900 text-white py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-10 left-10 w-3 h-3 bg-emerald-400 rounded-full"></div>
          <div className="absolute top-20 right-20 w-4 h-4 bg-teal-400 rounded-full"></div>
          <div className="absolute bottom-20 left-20 w-2 h-2 bg-cyan-300 rounded-full"></div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <Link 
              to="/" 
              className="inline-flex items-center gap-2 text-emerald-200 hover:text-white mb-6 transition-colors font-medium"
            >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              How <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 via-teal-300 to-cyan-300">EcoLoop</span> Works
            </h1>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className="text-center p-6 bg-gradient-to-br from-gray-50 to-white rounded-2xl border-2 border-gray-200 hover:border-emerald-300 transition-all duration-300">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-emerald-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden lg:block">
            ...
            {/* Step Details */}
            <div className="mt-16 bg-white rounded-2xl shadow-lg border-2 border-gray-200 overflow-hidden">
                ...
                <div className="p-8">
                  <div className="flex items-center gap-4 mb-6">
                    {(() => {
                      ...
                      return (
                        <div className={`w-16 h-16 bg-gradient-to-r ${steps[activeStep].color} rounded-2xl flex items-center justify-center shadow-lg`}>
                          <StepIcon className="w-8 h-8 text-white" strokeWidth={2.5} />
                        </div>
                      );
                    })()}
                    <div>
                ...
                <div className="bg-gradient-to-br from-emerald-50 to-teal-50 p-8 flex items-center justify-center">
                  <div className="text-center">
                    {(() => {
                      ...
                      return (
                        <div className="relative">
                          <div className={`w-32 h-32 bg-gradient-to-r ${steps[activeStep].color} rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-2xl`}>
                            <StepIcon className="w-16 h-16 text-white" strokeWidth={2} />
                          </div>
                        </div>
                      );
                    })()}
          ...
          <div className="text-center mt-12">
            <div className="bg-gradient-to-r from-emerald-500 to-teal-600 rounded-2xl p-8 text-white shadow-xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/schedule-pickup"
                  className="inline-flex items-center justify-center gap-2 bg-white text-emerald-700 hover:bg-gray-100 font-bold px-8 py-4 rounded-xl transition-all duration-300 shadow-lg"
                >
                ...
                <Link
                  to="/contact"
                  className="inline-flex items-center justify-center gap-2 border-2 border-white text-white hover:bg-white/10 font-bold px-8 py-4 rounded-xl transition-all duration-300"
                >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Frequently Asked <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-teal-600">Questions</span>
            </h2>
          ...
          {/* Additional Help */}
          <div className="text-center mt-12">
            <div className="bg-gradient-to-r from-gray-50 to-emerald-50 rounded-2xl p-8 border-2 border-gray-200">
      ...
      <section className="py-16 bg-gradient-to-r from-emerald-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            to="/schedule-pickup"
            className="inline-flex items-center gap-3 bg-white text-emerald-700 hover:bg-gray-100 font-bold text-lg px-8 py-4 rounded-xl shadow-2xl transition-all duration-300"
          >
